...
Launch OpenClaw non-interactively with the benchmark task from stdin. Configure
...
Record version, model, token, call, and cost fields that OpenClaw exposes in the
